...
const Quarterfinals = () => {
    ...
    useEffect(() => {
        ...
        const fetchSemis = async () => {
          try {
              const data = await getSemifinalMatches(tournament.id, user.id); // Fetch semis matches
      ...
      console.log(tournament.id, user.id)

      const fetchFinal = async () => {
        try {
            const data = await getFinalMatches(tournament.id, user.id); // Fetch final matches
